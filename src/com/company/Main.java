...
public class Main {
	...
	// Comments
        ...
        System.out.println("This is printed after the first 3 comments, and java didn't read any of them.");
    ...
    //New method to contain code on variables
...
//            System.out.println("the value of a is: " + a);
        ...
        {
            int i = 0;
            // the variable 'i' is only visible inside the block.
        }
...
//        System.out.println(i);
    ...
    static void assignmentOperators() {
        ...
        // *= this operator multiples the specified value with the existing variable
